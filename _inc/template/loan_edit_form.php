    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <select class="form-control select2" name="loan_from">
          ...
          <option value="bank" <?php echo $loan['loan_from'] == 'bank' ? 'selected' : null;?>>Banco</option>
          <option value="ngo" <?php echo $loan['loan_from'] == 'ngo' ? 'selected' : null;?>>Negocio</option>
          <option value="person" <?php echo $loan['loan_from'] == 'person' ? 'selected' : null;?>>Persona</option>
          <option value="others" <?php echo $loan['loan_from'] == 'others' ? 'selected' : null;?>>Otro</option>
       </select>
      </div>
    </div>
