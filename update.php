...
<html lang="en">
  <head>
    ...
    <title>Actualizar POS moderno desde v2.0 - v3.0</title>
...
<div class="container">
        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-default header" style="">
                <div class="panel-heading text-center">
                    <h2>Actualizar POS moderno desde v2.0 to v3.0</h2>
                    <h1>STEP 
    ...
    <div class="row" style="margin-top: 10px;">
        <div class="col-sm-8 col-sm-offset-2">  
            ...
            <div class="text-center copyright">&copy; <a href="https://www.delphiniagencia.digital">Delphini Agencia Digital</a>, Todos los Derechos Reservados.</div>
        </div>
    </div>
</div>
