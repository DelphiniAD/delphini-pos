...
<div class="hidden"><?php include('assets/itsolution24/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" value="skornz0711@gmail.com" placeholder="Email / Phone No." name="username">
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="password" class="form-control" value="akatsuki18" placeholder="Password" name="password">
          </div>
        </div>
        ...
        <table class="table table-bordered table-striped">
          <tbody>
            <?php foreach (get_users() as $the_user) : ?>
              <?php if (in_array($the_user['email'], array('admin@delphini.com', 'cashier@delphini.com', 'salesman@delphini.com'))) : ?>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="delphiniagencia.digital">Mas proyectos aqui</a>, </p>
    </div>
  </section>
